export function Button({
    ...
    const baseStyles = "px-6 py-3 rounded-xl font-medium tracking-wide transition-all duration-300 active:scale-95 disabled:opacity-50 flex items-center justify-center gap-2";
